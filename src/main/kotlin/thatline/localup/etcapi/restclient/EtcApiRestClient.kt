...
class EtcApiRestClient(
    ...
    fun getUltraSrtNcst(
        ...
        val uri = UriComponentsBuilder
            ...
            .queryParam("dataType", etcApiProperty.kma.vilageFcstInfoService.getUltraSrtNcst.dateType)
    ...
    fun getFcstVersion(
        ...
        val uri = UriComponentsBuilder
            ...
            .queryParam("pageNo", pageNo)
            .queryParam("numOfRows", numOfRows)
            .queryParam("dataType", etcApiProperty.kma.vilageFcstInfoService.getFcstVersion.dateType)

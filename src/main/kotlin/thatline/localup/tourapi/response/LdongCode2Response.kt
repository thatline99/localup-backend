...
/**
 * 한국관광공사_국문 관광정보 서비스_GW: 법정동코드조회 응답
 *
 * @property response 응답
 */
data class LdongCode2Response(
    ...
    data class Body(
        ...
        // 특정 lDongRegnCd 데이터가 없을 경우, items 필드가 빈 문자열로 응답되는 케이스를 처리하기 위한 메서드
     ...
     *
     * @property rnum 일련번호
     * @property code 법정동 : 시도 코드, 시군구 코드
     * @property name 법정동 : 시도명, 시군구명
     */
    data class Item(
        val rnum: Long,
        val code: String,
